...
import (
	...
	v1 "github.com/copybird/copybird/operator/pkg/client/listers/backup/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.BackupsV1().Backups(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BackupsV1().Backups(namespace).Watch(options)
			},
		},
		&backupv1.Backup{},
		resyncPeriod,
...
func (f *backupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&backupv1.Backup{}, f.defaultInformer)
}
